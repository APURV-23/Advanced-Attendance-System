...
# image1
        img_left=Image.open(r'img\face_detector1.jpg')
        img_left=img_left.resize((500,630),Image.ANTIALIAS)#High level to low
        self.photoimg_left=ImageTk.PhotoImage(img_left)
        f_lbl=Label(self.root,image=self.photoimg_left)
        f_lbl.place(x=0,y=35,width=500,height=630)
# image2
        img_right=Image.open(r'img\facial_recognition_system_identification_digital_id_security_scanning_thinkstock_858236252_3x3-100740902-large.jpg')
        img_right=img_right.resize((868,630),Image.ANTIALIAS)#High level to low
        self.photoimg_right=ImageTk.PhotoImage(img_right)
        f_lbl=Label(self.root,image=self.photoimg_right)
        f_lbl.place(x=500,y=35,width=868,height=630)

        title_lbl=Label(self.root,text="Frontal Face Detector",font=("times new roman",15,"bold"),bg="white",fg="blue")
        title_lbl.place(x=0,y=660,width=1368,height=35)

         # button

        b1_1=Button(self.root,text="Face Recognition",command=self.face_recog,cursor="hand2",font=("times new roman",15,"bold"),bg="darkblue",fg="white")
        b1_1.place(x=830,y=600,width=200,height=30)
